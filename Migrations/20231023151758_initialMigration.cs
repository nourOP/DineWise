    ...
    public partial class initialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OverwriteSchedule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OverwriteSchedule_Restaurants_RestaurantId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestaurantTableFeatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RestaurantTableFeatures_Features_FeatureId",
                        column: x => x.FeatureId,
                        principalTable: "Features",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantTableFeatures_RestaurantTables_RestaurantTableId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OverwriteSchedule_RestaurantId",
                table: "OverwriteSchedule",
                column: "RestaurantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantTableFeatures_FeatureId",
                table: "RestaurantTableFeatures",
                column: "FeatureId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantTableFeatures_RestaurantTableId",
                table: "RestaurantTableFeatures",
                column: "RestaurantTableId");
